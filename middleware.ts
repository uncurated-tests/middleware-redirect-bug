...
export default function middleware(req: NextRequest) {
  ...
  if (path === "/another-redirect") {
    return NextResponse.redirect(
      "https://guides.apple.com/?ug=CglEVUIgR3VpZGUSDgjZMhDEo+GA+ZKqpJUBEg4I2TIQw7y33++6ifL+ARIOCNkyEJC988jqgIrQjQESDgjZMhCB+7XSiPTwrfUBEg4I2TIQ5J25xZOynPDxARINCNkyENuVr4POz8aMcBIOCMI7EK36pfjQuerJ0gESDQjCOxDSuurnjM6T7mASDQjCOxD3vr//kq/LqUwSDQjCOxCg9cK+jeOhnS4="
    );
  }
}
